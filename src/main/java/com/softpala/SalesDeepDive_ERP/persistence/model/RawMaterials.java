...
public class RawMaterials {
    ...
    @OneToMany(mappedBy = "rawMaterialUsage")
    @JsonIgnore
    ...
    public RawMaterials(String name, String code, String size, String description,double quantity,String unit_of_measure,int lead_time,int sequence) {
        this.name = name;
        this.code = code;
        this.size = size;
...
//
    ...
    public boolean equals(final Object obj) {
        ...
        final RawMaterials subsidiary = (RawMaterials) obj;
    ...
    public String toString() {
        ...
        builder.append("RawMaterials [name=").append(name).append("]").append("[id=").append(id).append("]");
