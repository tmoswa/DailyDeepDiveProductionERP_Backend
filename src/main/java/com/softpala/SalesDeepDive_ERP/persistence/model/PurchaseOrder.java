...
public class PurchaseOrder {
    ...
    public PurchaseOrder(RawMaterials ntMs, MainEntity main_entity_po, MainEntity supplier, String description, double quantity, String status, String name, String url,int order_number) {
        this.ntMs = ntMs;
    ...
    public PurchaseOrder(RawMaterials ntMs, MainEntity main_entity_po, MainEntity supplier, Collection<Invoice> invoices, String description, double quantity, String status, String name, String url, int order_number, LocalDate order_date, LocalDate delivery_date, double delivered_quantity) {
        this.ntMs = ntMs;
        this.main_entity_po = main_entity_po;
        this.supplier = supplier;
...
//
    ...
    public RawMaterials getNtMs() {
        return ntMs;
    }

    public void setNtMs(RawMaterials ntMs) {
        this.ntMs = ntMs;
    }
