package com.softpala.SalesDeepDive_ERP.api.auth;

import com.softpala.SalesDeepDive_ERP.api.main.inc.ActivityLogService;
import com.softpala.SalesDeepDive_ERP.api.util.GenericResponse;
...
import com.softpala.SalesDeepDive_ERP.persistence.dao.UserRepository;
...
import com.softpala.SalesDeepDive_ERP.persistence.model.VerificationToken;
import com.softpala.SalesDeepDive_ERP.registration.OnRegistrationCompleteEvent;
import com.softpala.SalesDeepDive_ERP.registration.listener.RegistrationListener;
    ...
    public ResponseEntity<Response> getUsers() {
        return  ResponseEntity.ok(
                Response.builder()
                        ...
                        .data_corresponding(of("roles",userService.roleList(300)))
                        .data_corresponding0(of("subsidiaries",userService.subsidiaryList(300)))
                        .data_corresponding1(of("designations",userService.designationList(300)))
